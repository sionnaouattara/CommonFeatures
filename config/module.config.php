...
use CommonFeatures\Factory\Helper\SerializerHelperFactory;
...
return [
    'service_manager' => [
        'aliases' => [
            ...
            'jms_serializer.serializer'=> Service\Serializer::class
        ],
        'factories' => [
            ...
            Factory\Repository\CustomRepositoryFactory::class => InvokableFactory::class,

            'Dompdf\Dompdf'           => Factory\DOMPDFFactory::class,
            'ViewPdfRenderer' => Factory\ViewPdfRendererFactory::class,
            'ViewPdfStrategy' => Factory\ViewPdfStrategyFactory::class,
        ],
        'shared' => [
            /**
        ...
        'invokables' => [
            'cf_event_manager' => SharedEventManager::class,
        ],
    ],
    'common_features_module' => [
        /**
         ...
         * @var string
         */
        'log_output_file' => __DIR__ . '/../../../data/log/pdf',
        /**
    ...
    'controller_plugins' => [
        'factories' => [
            Plugin\PrinterPlugin::class => InvokableFactory::class,
        ],
        'aliases' => [
            'printerPlugin' => Plugin\PrinterPlugin::class
        ],
    ],
    'view_manager' => [
        'strategies' => [
    ...
    'view_helpers' => [
        'factories' => [
            'jmsSerializer' => SerializerHelperFactory::class,
        ],
    ],
    'doctrine' => [
        'driver' => [
